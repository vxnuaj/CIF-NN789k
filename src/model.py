...
def gradient_descent(x, y, w1, b1, g1, w2, b2, g2, ewa_mu1, ewa_var1, ewa_mu2, ewa_var2, alpha, beta_1, beta_2, epochs, file, file2): 
...
def model(x, y, input_features, hidden_sizes, output_size, alpha, beta_1, beta_2, epochs, file, file2): 
    try:
    ...
    w1, b1, g1, w2, b2, g2, epochs_vec, loss_vec, acc_vec, itr_vec, ewa_mu1, ewa_var1, ewa_mu2, ewa_var2 = gradient_descent(x, y, w1, b1, g1, w2, b2, g2, ewa_mu1, ewa_var1, ewa_mu2, ewa_var2, alpha, beta_1, beta_2, epochs, file, file2)
